...
Bin_center=5*2**(np.arange(0,N_bin+1,1))*1e-6 #center of each bin
...
pam.df.addHydrometeor(("ice",-99., -1 , Rho_ice, -99., -99.,-99. , -99., 3 ,N_bin,"mono",-99.0, -99.0, -99.0, -99.0,2*50e-6,-99.0,"mie-sphere",0.,0.0))
...
pam.df.addHydrometeor(("rain",-99.,  1 , Rho_rain , -99., -99.,-99. , -99., 3 ,N_bin,"mono",-99.0, -99.0, -99.0, -99.0,2*r_rain,-99.0,"mie-sphere",rain_fallspeed,0.0))
...
pam.df.addHydrometeor(("snow",-99., -1 , Rho_snow, -99., -99.,-99. , -99., 3 ,N_bin,"mono",-99.0, -99.0, -99.0, -99.0,2*r_snow,-99.0,"mie-sphere",snow_fallspeed,0.0))
...
pam.df.addHydrometeor(("cirrus", C_cirrus, -1 , Rho_ice,  130., 3.0 ,0.684, 2.  , 3 ,N_bin, "mono_cosmo_ice", -99., -99., -99., -99., 2*r_ice, -99., "mie-sphere", "heymsfield10_particles",0.0))
...
if FULL_SPECTRA==True:
    ...
    ##___LIQ:
    pam.df.dataFullSpec["rho_ds"][:,:,:,id_liq,0:]=1000.
    pam.df.dataFullSpec["d_ds"][:,:,:,id_liq,0]=2*r_liq
    pam.df.dataFullSpec["d_bound_ds"][:,:,:,id_liq,0]=[r_liq,4*r_liq]
    pam.df.dataFullSpec["n_ds"][:,:,:,id_liq,0]=N_liq
    pam.df.dataFullSpec["mass_ds"][:,:,:,id_liq,0]=q_hydro[:jsel,:,:,id_liq]
    pam.df.dataFullSpec["area_ds"][:,:,:,id_liq,0]=np.pi*r_liq**2
    pam.df.dataFullSpec["as_ratio"][:,:,:,id_liq,0]=1.
    pam.df.dataFullSpec["canting"][:,:,:,id_liq,0]=0.
    pam.df.dataFullSpec["fallvelocity"][:,:,:,id_liq,0]=0.#liq_fallspeed
    pam.df.dataFullSpec["rg_beta_ds"][:,:,:,id_liq,0]=-99.
    pam.df.dataFullSpec["rg_kappa_ds"][:,:,:,id_liq,0]=-99.
    pam.df.dataFullSpec["rg_gamma_ds"][:,:,:,id_liq,0]=-99.
    pam.df.dataFullSpec["rg_zeta_ds"][:,:,:,id_liq,0]=-99.

    ##___RAIN:
    pam.df.dataFullSpec["rho_ds"][:,:,:,id_rain,0]=1000.
    pam.df.dataFullSpec["d_ds"][:,:,:,id_rain,0]=2*r_rain
    pam.df.dataFullSpec["d_bound_ds"][:,:,:,id_rain,0]=[r_rain,4*r_rain]
    ...
    pam.df.dataFullSpec["area_ds"][:,:,:,id_rain,0]=np.pi*r_liq**2
    pam.df.dataFullSpec["as_ratio"][:,:,:,id_rain,0]=1.
    pam.df.dataFullSpec["canting"][:,:,:,id_rain,0]=0.
    pam.df.dataFullSpec["fallvelocity"][:,:,:,id_rain,0]=rain_fallspeed
    pam.df.dataFullSpec["rg_beta_ds"][:,:,:,id_rain,0]=-99.
    pam.df.dataFullSpec["rg_kappa_ds"][:,:,:,id_rain,0]=-99.
    pam.df.dataFullSpec["rg_gamma_ds"][:,:,:,id_rain,0]=-99.
    pam.df.dataFullSpec["rg_zeta_ds"][:,:,:,id_rain,0]=-99.

    ##___SNOW:
    pam.df.dataFullSpec["rho_ds"][:,:,:,id_snow,0]=Rho_snow
    pam.df.dataFullSpec["d_ds"][:,:,:,id_snow,0]=2*r_snow
    pam.df.dataFullSpec["d_bound_ds"][:,:,:,id_snow,0]=[r_snow,4*r_snow]
    pam.df.dataFullSpec["n_ds"][:,:,:,id_snow,0]=N_snow
    pam.df.dataFullSpec["mass_ds"][:,:,:,id_snow,0]=q_hydro[:jsel,:,:,id_snow]
    pam.df.dataFullSpec["area_ds"][:,:,:,id_snow,0]=-99 #np.pi*r_snow**2
    pam.df.dataFullSpec["as_ratio"][:,:,:,id_snow,0]=AR_snow
    pam.df.dataFullSpec["canting"][:,:,:,id_snow,0]=0.
    pam.df.dataFullSpec["fallvelocity"][:,:,:,id_snow,0]=snow_fallspeed
    pam.df.dataFullSpec["rg_beta_ds"][:,:,:,id_snow,0]=-99.
    pam.df.dataFullSpec["rg_kappa_ds"][:,:,:,id_snow,0]=-99.
    pam.df.dataFullSpec["rg_gamma_ds"][:,:,:,id_snow,0]=-99.
    pam.df.dataFullSpec["rg_zeta_ds"][:,:,:,id_snow,0]=-99.

    ##___CIRRUS
    pam.df.dataFullSpec["rho_ds"][:,:,:,id_cir,0]=Rho_cir
    pam.df.dataFullSpec["d_ds"][:,:,:,id_cir,0]=2*r_cir
    pam.df.dataFullSpec["d_bound_ds"][:,:,:,id_cir,0]=[0,4]#4*np.max(r_cir)]
    pam.df.dataFullSpec["n_ds"][:,:,:,id_cir,0]=N_cir
    pam.df.dataFullSpec["mass_ds"][:,:,:,id_cir,0]=q_hydro[:jsel,:,:,id_cir]
    pam.df.dataFullSpec["area_ds"][:,:,:,id_cir,0]=-99 #np.pi*r_cir**2
    pam.df.dataFullSpec["as_ratio"][:,:,:,id_cir,0]=AR_cir
    pam.df.dataFullSpec["canting"][:,:,:,id_cir,0]=0.
    pam.df.dataFullSpec["fallvelocity"][:,:,:,id_cir,0]=0.#snow_fallspeed
    pam.df.dataFullSpec["rg_beta_ds"][:,:,:,id_cir,0]=-99.
    pam.df.dataFullSpec["rg_kappa_ds"][:,:,:,id_cir,0]=-99.
    pam.df.dataFullSpec["rg_gamma_ds"][:,:,:,id_cir,0]=-99.
    pam.df.dataFullSpec["rg_zeta_ds"][:,:,:,id_cir,0]=-99.

    ##___ICE
    #for i in range(0,N_bin):
    pam.df.dataFullSpec["rho_ds"][:,:,:,id_ice,:]=Rho_ice
    pam.df.dataFullSpec["d_ds"][:,:,:,id_ice,:]=Bin_center
    pam.df.dataFullSpec["d_bound_ds"][:,:,:,id_ice,:]=[Bin_edges[:-1],Bin_edges[1:]]#4*np.max(r_cir)]
    pam.df.dataFullSpec["n_ds"][:,:,:,id_ice,:]=nb_crystals_bin[:jsel,:,:,:]
    pam.df.dataFullSpec["mass_ds"][:,:,:,id_ice,:]=q_hydro[:jsel,:,:,:]
...
output_file = "/home/grzegorc/AWACA/PAMTRA/pamtra/Ouput_cosp_final_fullspec.nc"
